...
try:
    from squint_rl.reward import MatchCounts, RewardState, box_iou
except ModuleNotFoundError:
    MatchCounts = RewardState = box_iou = None
...
def test_reward_api_is_available() -> None:
    assert RewardState is not None
    assert MatchCounts is not None
